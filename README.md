...
![image(https://user-images.githubusercontent.com/73158407/103190955-42e92c00-4890-11eb-9d9c-214397ee192f.png)
  ...
  III.INSERT INTO `customer`(`cid`, `Name`, `phoneno`, `address`, `waiterid`)                                                                             
 ...
 III.delete from 'order' where oid='1'                                                            
 ...
 III.SELECT name FROM 'meal' ORDER BY chefid ASC                                                                         
 ![image(https://user-images.githubusercontent.com/73158407/103196167-e4787980-48a0-11eb-95b8-7d0f5d36a2fa.png)
  ...
  III.SELECT * FROM Customer WHERE address='Gold Coast';                                                                         
...
# Query 5
  ...
  right table (Orders).                      
  III.SELECT Customer.Name, orders.oid                                                                            
      FROM Customer                                                                                                       
      LEFT JOIN orders                                                                                                  
 ...
 # Query 6
  ...
  III.SELECT orders.oid, customer.Name                                                                                           
   FROM orders                                                                                                                              
 ...
 # Query 7
  ...
  III.SELECT orders.oid, customer.Name, customer.address                                                                                                          
     FROM orders                                                                                                                                                     
...
# Query 8
  ...
  III.select distinct salary from chef a where 3 >= (select count(distinct salary) from chef b where a.salary <= b.salary) order by a.salary desc
...
# Query 9
 ...
 III.SELECT COUNT(mid) FROM meal                                                                             
 ...
 III.SELECT MIN(Price) AS SmallestPrice FROM meal                                                                  
 ...
 III.SELECT AVG(Price) FROM meal                              
 ...
 III.SELECT MAX(salary) AS HighestSalary FROM waiter                                                                     
...
III.SELECT COUNT(cid), address FROM customer GROUP BY address                                                  
![image(https://user-images.githubusercontent.com/73158407/103216109-7482e700-48d2-11eb-8252-81c39cece469.png)
 ...
 III.SELECT * FROM customer WHERE address IN ('Melbourne', 'Perth','Gold Coast' )                                                                             
 ...
 III.SELECT * FROM customer WHERE address NOT IN ('Melbourne', 'Perth','Gold Coast' )                                  
 ...
 III.SELECT A.Name AS name1, B.name AS name2, A.address FROM customer A, customer B WHERE A.cid <> B.cid AND A.address = B.address ORDER BY A.address
 ...
 III.SELECT cid, Name FROM customer WHERE EXISTS( SELECT NULL) ORDER BY name                                               
 ...
 III.SELECT DISTINCT salary FROM waiter ORDER BY salary DESC                                                           
